...
const checks = [
  ...
  ['푸터 대표자 확정 문구', files.html.includes('모두의클리어 대표이사: 최인란')],
  ...
  ['캐시 버전 일치', files.html.includes('styles.css?v=42') && files.html.includes('live-app.js?v=42') && files.app.includes("api-client.js?v=42") && (await readFile(new URL('../public/sw.js', import.meta.url), 'utf8')).includes("modu-challenge-v42") && (await readFile(new URL('../public/_headers', import.meta.url), 'utf8')).includes('/sw.js\n  Cache-Control: no-cache')],
