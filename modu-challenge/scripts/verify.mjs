...
const checks = [
  ...
  ['미션 카드 단색 5종·보상금 강조', ['plum', 'forest', 'terracotta', 'charcoal', 'teal'].every((theme) => files.app.includes(`'${theme}'`) && files.css.includes(`.card-theme-${theme}`)) && files.app.includes('CARD_THEME_BY_CATEGORY') && files.app.includes('data-card-theme=') && !files.app.includes('challenge-visual-art') && !files.app.includes('challenge-visual-spark') && files.css.includes('font-size: clamp(1.32rem, 1.7vw, 1.48rem)') && files.css.includes('.challenge-card:focus-visible')],
  ...
  ['캐시 버전 일치', files.html.includes('styles.css?v=49') && files.html.includes('live-app.js?v=49') && files.app.includes("api-client.js?v=49") && (await readFile(new URL('../public/sw.js', import.meta.url), 'utf8')).includes("modu-challenge-v49") && (await readFile(new URL('../public/_headers', import.meta.url), 'utf8')).includes('/sw.js\n  Cache-Control: no-cache')],
