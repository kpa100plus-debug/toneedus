...
const checks = [
  ...
  ['LIVE 카드 이동·입력 정렬', files.css.includes('heroBoardFloat 6s') && files.css.includes('translate3d(-220px, -245px, 0)') && files.css.includes('.hero-board:hover') && files.app.includes('reward-schedule-grid') && files.css.includes('.reward-schedule-grid')],
