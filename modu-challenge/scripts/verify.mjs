...
const checks = [
  ...
  ['단일 수행자 후보', files.worker.includes("WHEN status = 'SHORTLISTED' THEN 'VIEWED'") && files.worker.includes('singleCandidate: true') && files.app.includes('수행자 후보는 한 번에 1명만 선택됩니다')],
