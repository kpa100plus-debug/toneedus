...
const checks = [
  ...
  ['소셜 로그인 사전 안내', files.app.includes('openSocialLoginConfirmation') && files.app.includes('confirm-oauth-login') && files.app.includes('일반 회원가입과 이메일 인증을 완료한 계정만')],
  ...
  ['캐시 버전 일치', files.html.includes('styles.css?v=35') && files.html.includes('live-app.js?v=36') && files.app.includes("api-client.js?v=36") && (await readFile(new URL('../public/sw.js', import.meta.url), 'utf8')).includes("modu-challenge-v36") && (await readFile(new URL('../public/_headers', import.meta.url), 'utf8')).includes('/sw.js\n  Cache-Control: no-cache')],
