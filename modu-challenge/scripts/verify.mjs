...
const checks = [
  ...
  ['자동검수·저위험 자동승인', files.worker.includes('assessChallengeModeration') && files.worker.includes('CHALLENGE_MODERATION_AUTO_APPROVED') && files.worker.includes('autoReviewPendingChallenges') && files.client.includes('autoReviewModerationQueue') && files.app.includes('전체 자동 재검수') && files.automatedModerationMigration.includes('moderation_decision')],
  ...
  ['캐시 버전 일치', files.html.includes('styles.css?v=51') && files.html.includes('live-app.js?v=51') && files.app.includes("api-client.js?v=51") && (await readFile(new URL('../public/sw.js', import.meta.url), 'utf8')).includes("modu-challenge-v51") && (await readFile(new URL('../public/_headers', import.meta.url), 'utf8')).includes('/sw.js\n  Cache-Control: no-cache')],
