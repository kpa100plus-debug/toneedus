...
const checks = [
  ...
  ['LIVE 카드 이동·입력 정렬', files.css.includes('heroBoardFloat 8s') && files.css.includes('calc(-100vw + 720px)') && files.css.includes('background: #a8df7d') && files.css.includes('.hero-board:hover') && files.app.includes('reward-schedule-grid') && files.css.includes('.reward-schedule-grid')],
