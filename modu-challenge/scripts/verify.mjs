...
const checks = [
  ...
  ['LIVE 카드 이동·입력 정렬', files.css.includes('@keyframes heroBoardFloat') && files.css.includes('.hero-board:hover') && files.app.includes('reward-schedule-grid') && files.css.includes('.reward-schedule-grid')],
