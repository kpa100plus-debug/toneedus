...
export const apiClient = {
  ...
  emailVerification: () => api('/api/me/email-verification'),
  sendEmailCode: (data) => api('/api/me/email-verification/send', { method: 'POST', body: data }),
  confirmEmailCode: (data) => api('/api/me/email-verification/confirm', { method: 'POST', body: data }),
