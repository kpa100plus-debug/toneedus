...
const checks = [
  ...
  ['대표자 개인정보 비표시', files.html.includes('모두의 챌린지 운영팀') && !files.html.includes('대표이사: 최인란')],
  ...
  ['캐시 버전 일치', files.html.includes('styles.css?v=34') && files.html.includes('live-app.js?v=34') && files.app.includes("api-client.js?v=34") && (await readFile(new URL('../public/sw.js', import.meta.url), 'utf8')).includes("modu-challenge-v34") && (await readFile(new URL('../public/_headers', import.meta.url), 'utf8')).includes('/sw.js\n  Cache-Control: no-cache')],
